...
def market():
    ...
    top = final[(final.symbol.str.contains('BTCDOWNUSDT'))].append(final[(final.symbol.str.contains('ETHUSDT'))]).append(final[(final.symbol.str.contains('XAUTUSDT'))])
    up = up.append(top)
